...
print("To make the annotation utilities available in a current terminal session use the command:")
print(command)
...
if os.path.exists(os.path.expanduser("~/.bashrc")):
	...
	if usrin.upper()=="Y":
		...
		bashrc.write("\n\n")
		bashrc.write("# Added by annotation utilities install.py script to update file path\n")
